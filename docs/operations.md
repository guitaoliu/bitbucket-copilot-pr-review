...
The reviewer inspects all changed files that remain after filtering.
...
- `review.ignorePaths` excludes noisy generated or localized assets from reportable finding scope
